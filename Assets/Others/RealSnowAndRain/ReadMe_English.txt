...
This is useful, if you want to Rain and Snow effects will follow the camera in the moving train or flying airplane.
If you simply drag and drop camera object ( in train or airplane or any moving object having camera ) in the scene to "Following Camera" property in inspector about RainParticleCollisionProcess.cs script or SnowParticleCollisionProcess.cs, particle effect will follows the camera. 
